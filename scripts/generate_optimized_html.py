...
HOTELS = [
    {
        "area": "成都",
        "badge": "首选·景观",
        "name": "成都太古里Pagoda君亭酒店",
        "score": "4.8/5",
        "view": "高层城市景观，位置和早餐综合表现好",
        "location": "春熙路/太古里，适合D1、D2和D4、D5",
        "booking": "约¥350–650/晚；国庆需以实时订单为准",
        "url": "https://hotels.ctrip.com/hotels/86222798.html",
        "source": "携程酒店页 + Trip.com住客评价",
    },
    {
        "area": "成都",
        "badge": "性价比",
        "name": "成都美居酒店（春熙路/太古里附近）",
        "score": "4.7/5",
        "view": "部分房型可看城市景观，房间新、交通方便",
        "location": "春熙路商圈，适合不换酒店",
        "booking": "约¥280–500/晚；按房型和日期浮动",
        "url": "https://hotels.ctrip.com/hotels/21132716.html",
        "source": "携程酒店页；预订时确认具体房型视野",
    },
    {
        "area": "成都",
        "badge": "高预算",
    ...
    },
    {
        ...
        "name": "九寨沟漫心酒店",
        "score": "4.7/5",
        "view": "山景和藏式氛围较好，适合只住一晚的效率型安排",
        "location": "漳扎镇沟口片区；重点确认到游客中心的接驳/步行距离",
        "booking": "约¥450–800/晚；国庆价格波动最大",
        "url": "https://hotels.ctrip.com/hotels/131950085.html",
        "source": "携程酒店页；下单前核对接送服务和早餐时间",
    },
    {
        "area": "九寨沟沟口",
        "badge": "景观·停车",
    ...
    },
    {
        ...
        "name": "四姑娘山3000M酒店",
        "score": "4.7/5",
        "view": "山景、房间舒适度和高原配套较均衡",
        "location": "四姑娘山镇，方便D7双桥沟早出发",
        "booking": "约¥500–900/晚；确认供氧、地暖和停车",
        "url": "https://hotels.ctrip.com/hotels/134918278.html",
        "source": "携程酒店页；下单前看当日房型配置",
    },
    {
        "area": "四姑娘山",
        "badge": "风景优先",
        "name": "宿境·山里见",
        "score": "4.8/5",
        "view": "更适合看山和拍照，氛围感优于标准商务酒店",
        "location": "四姑娘山镇周边；确认到双桥沟游客中心距离",
        "booking": "约¥600–1000/晚；国庆库存少，价格易上浮",
        "url": "https://hotels.ctrip.com/hotels/107169531.html",
        "source": "携程酒店页；重点核对停车、供氧和暖气",
    },
    {
        "area": "四姑娘山",
        "badge": "稳妥备选",
    ...
    },
    {
        ...
        "name": "新都桥悠然牧云设计师艺术酒店",
        "score": "4.7/5",
        "view": "草原、远山、落地窗和公共空间出片，适合小环线住一晚",
        "location": "新都桥镇周边；自驾方便，离主街有一定距离",
        "booking": "约¥700–1200/晚；国庆先确认供氧、地暖和早餐",
        "url": "https://hotels.ctrip.com/hotels/121067154.html",
        "source": "携程酒店页及2026年住客评价；风景取决于房型和天气",
    },
    {
        "area": "新都桥",
        "badge": "性价比",
        "name": "新都桥萨玛精品民宿",
        "score": "4.8/5",
        "view": "部分房间和屋顶可看山景，停车方便，适合自驾落脚",
        "location": "新都桥镇天堂小镇片区，靠近餐饮和景观路段",
        "booking": "约¥400–800/晚；确认房型供氧和是否含早餐",
        "url": "https://hotels.ctrip.com/hotels/95062956.html",
        "source": "携程酒店页及2026年住客评价",
    },
    {
        "area": "新都桥",
        "badge": "供氧·停车",
        "name": "新都桥云宸·山野全景·供氧酒店",
        "score": "4.5/5",
        "view": "山野景观、供氧设施和免费停车更适合高原恢复",
        "location": "新都桥镇岗丘上路，适合自驾；晚餐可能需要开车",
        "booking": "约¥500–900/晚；确认供氧设备、热水和餐厅营业",
        "url": "https://hotels.ctrip.com/hotels/129332916.html",
        "source": "携程酒店页；优先看近期评价和具体房型",
    },
]
...
<p class="lead">以下是按本次路线筛选的实际住宿候选。价格是国庆前后预算区间，不是承诺价；网页链接用于核对房型、评价和实时库存，排除了单纯广告式“必住”表述。</p>
<div class="notice"><b>先说结论：</b>成都选太古里Pagoda君亭；九寨沟只住D3一晚，选漫心，满房再看千鹤或智选假日；四姑娘山优先3000M；D7完整小环线落脚新都桥，景观优先悠然牧云，预算优先萨玛。</div>
{}
...
<tr><td>成都</td><td class="best">Pagoda君亭</td><td>太古里位置、城市景观和早餐较均衡，适合多晚不换酒店。</td><td>预算压缩选美居；想要高层景观和服务选尼依格罗。</td><td>确认观景房朝向、是否含早餐、到成都东站打车时间。</td></tr>
<tr><td>九寨沟沟口</td><td class="best">漫心</td><td>只住一晚时更看重沟口效率、房间舒适度和山景氛围。</td><td>千鹤更适合停车和公共空间；智选假日更看重连锁标准。</td><td>确认到游客中心距离、接驳、早餐开始时间和退房寄存。</td></tr>
<tr><td>四姑娘山</td><td class="best">3000M</td><td>山景、高原配套、停车和双桥沟出行的综合平衡更好。</td><td>宿境·山里见偏风景氛围；阅山四季作为满房备选。</td><td>确认供氧、地暖/电热毯、热水、停车和房间具体朝向。</td></tr>
<tr><td>新都桥</td><td class="best">悠然牧云</td><td>完整小环线D7晚入住，景观、公区和供氧配套更适合拍照与恢复。</td><td>萨玛偏性价比；云宸偏供氧和停车。</td><td>确认D7晚到店时间、晚餐供应、供氧、地暖和到十里长廊距离。</td></tr>
</tbody></table></div>
